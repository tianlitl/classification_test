...
class PMG(nn.Module):
    def __init__(self, feature_size, classes_num=6): # utils.py resnet50,512,200
        ...
        self.conv_block1 = nn.Sequential(
            BasicConv(256, feature_size, kernel_size=1, stride=1, padding=0, relu=True),
        ...
        self.conv_block2 = nn.Sequential(
            BasicConv(640, feature_size, kernel_size=1, stride=1, padding=0, relu=True),
            BasicConv(feature_size, self.num_ftrs//2, kernel_size=3, stride=1, padding=1, relu=True)
        )
        ...
        self.conv_block3 = nn.Sequential(
            BasicConv(1664, feature_size, kernel_size=1, stride=1, padding=0, relu=True),
            BasicConv(feature_size, self.num_ftrs//2, kernel_size=3, stride=1, padding=1, relu=True)
        )
